    ...
    if (acceptCookies) {
        return (
            <div className="cookie-notification p-5 fixed bottom-10 left-6 right-6 bg-white z-10 lg:w-[50%] md:w-[80%] sm:w-[80%] mm:w-[75%] rounded-md shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)]">
                ...
                <button onClick={() => setAcceptCookies(false)} className="mm:m-2 sm:m-1 p-2 bg-premiumColor/100 text-white rounded-sm font-[500] hover:brightness-125 mm:text-xs sm:text-base">
                    Qəbul et
                </button>
