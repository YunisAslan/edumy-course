...
const Navbar = () => {
  ...
  return (
    <>
      <button
        className="bars-overlay absolute text-myBlack text-[2.5rem] z-[9]  pt-8 right-7 top-0 mm:block lg:hidden"
      ...
      <div
        ref={overlayRef}
        className="overlay font-navbarFont !h-0 !fixed bg-gradient-to-b from-navbarGradientFrom to-[#49607a] top-0 overflow-hidden z-[52] mm:block xl:hidden"
      >
        ...
        <button
          className="cross-overlay text-gray-100 text-[2rem] absolute right-10 top-10"
          onClick={handleOverlay}
        >
        ...
        <nav className="nav-links font-[300] flex flex-col pl-10 pt-14 text-2xl text-[#fffcf2] justify-center">
          <Link
            to="/"
            className="flex items-center tracking-wide py-3 max-w-[40%] relative before:absolute before:h-[2px] before:bg-white left-0 before:bottom-1 before:w-0 before:hover:w-full before:transition-all before:duration-700"
          >
            Ana Səhifə
          </Link>

          <button
            className="dropdown-trigger flex items-center py-3 tracking-wide max-w-[40%] relative before:absolute before:h-[2px] before:bg-white left-0 before:bottom-1 before:w-0 before:hover:w-full before:transition-all before:duration-700"
          ...
          <Link
            to="/contact"
            className="flex items-center tracking-wide py-3 max-w-[30%] relative before:absolute before:h-[2px] before:bg-white left-0 before:bottom-1 before:w-0 before:hover:w-full before:transition-all before:duration-700"
          >
            Əlaqə
          </Link>
        </nav>
