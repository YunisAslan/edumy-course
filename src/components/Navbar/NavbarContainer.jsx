    ...
    <>
      ...
      >
        ...
        <nav className="justify-center items-center gap-8 flex-1 text-[20px] pr-8 font-[500] mm:hidden lg:flex">
          ...
          <div
            className="relative"
            onMouseEnter={() => setDropLink(1)}
            onMouseLeave={() => setDropLink(null)}
          >
          ...
          <Link
            to="/contact"
            className="nav-link py-4 relative before:absolute before:h-[2px] before:bg-myBlack left-0 before:bottom-3 before:w-0 before:hover:w-full before:transition-all before:duration-[.4s]"
          >
            Əlaqə
          </Link>
        </nav>
        ...
        <div className="navbar-right flex items-center">
          <button
            className="home-sign-btn bg-blue-600 text-white hover:bg-blue-700 transition-colors duration-3000 flex items-center px-3 py-2 mr-[2rem] rounded-md  mm:hidden xl:flex"
          ...
          <button
            className="cart pr-2 relative"
            onClick={() => navigate("/addbasket")}
          >
          ...
          <div className="search">
            ...
            <button
              className="search-btn text-[1.8rem] pl-5 xl:pr-0 mm:pr-6"
              onClick={handleSearch}
            >
