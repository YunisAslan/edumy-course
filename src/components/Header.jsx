        ...
        <>
            <header className='overflow-x-hidden'>
                ...
                >
                    ...
                    <SwiperSlide className='slide' style={{ backgroundImage: `url(${headerImg1})`, backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: 'cover', height: "90vh" }}>
                        <div className='header-content'>
                            <h2 className='z-50 lg:text-[2.6rem] sm:text-[2.2rem] mm:text-[1.5rem] pb-1 font-[700] uppercase px-3'>Özünü təhsil resursları və məlumatları</h2>
                    ...
                    <SwiperSlide className='slide' style={{ backgroundImage: `url(${headerImg2})`, backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: 'cover', height: "90vh" }}>
                        <div className='header-content'>
                    ...
                    <SwiperSlide className='slide' style={{ backgroundImage: `url(${headerImg3})`, backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: 'cover', height: "90vh" }}>
                        <div className='header-content'>
